...
#define DSP_UDATA_REQUEST_SET_BREAK             10
/*
parameters:
  <byte> break option
         0: default (non destructive/non expedited)
         1: destructive/expedited
         2: non destructive/expedited
         3: non destructive/non expedited
  <word> break duration in milliseconds
*/
#define DSP_UDATA_REQUEST_CLEAR_BREAK           11
/*
parameters:
  - none -
*/
...
#define DSP_CONNECTED_NORM_CTM              37
#define DSP_CONNECTED_NORM_VOWN             38
#define DSP_CONNECTED_NORM_V23_OFF_HOOK     39
#define DSP_CONNECTED_NORM_V23_ON_HOOK      40
#define DSP_CONNECTED_NORM_V23_AUTO_FRAMER  41
#define DSP_CONNECTED_NORM_BELL202_CID      42
#define DSP_CONNECTED_NORM_TELENOT          43
...
#define DSP_CONNECTED_NORM_V34FAX_CONTROL   70
#define DSP_CONNECTED_NORM_V34FAX_PRIMARY   71
#define DSP_CONNECTED_NORM_V22_FAST_CONNECT 72
#define DSP_CONNECTED_NORM_V29_FAST_CONNECT 73
#define DSP_CONNECTED_NORM_V29_FC           74
#define DSP_CONNECTED_NORM_V27_FC           75
#define DSP_CONNECTED_NORM_V_FAST_CLASS     76
...
returns:
  <byte> cause
*/
#define DSP_UDATA_INDICATION_BREAK_SET          10
/*
returns:
  - none -
*/
#define DSP_UDATA_INDICATION_BREAK_CLEARED      11
/*
returns:
  - none -
*/
...
#define DLC_MODEMPROT_DISABLE_SDLC           0x40
#define DLC_MODEMPROT_NO_PROTOCOL_IF_1200    0x01
#define DLC_MODEMPROT_FLUSH_RX_IMMEDIATELY   0x02
...
/*
Fields in assign DLC information element for SDLC:
  <byte> length of information element
  <word> information field length
  <byte> address A       (not used, default 3)
  <byte> address B       (not used, default 1)
  ...
  <byte> SDLC options
*/
#define SDLC_OPTION_WAIT_CTS_DCD_ON          0x01
#define SDLC_OPTION_INDICATE_CTS_DCD_ON      0x02
#define SDLC_OPTION_PASS_INDICATIONS         0x04
#define SDLC_OPTION_SINGLE_DATA_PACKETS      0x08
#define SDLC_OPTION_REVERSE_ESTABLISHMENT    0x10
#define SDLC_OPTION_EXPLICIT_DATA_ACK        0x20
#define SDLC_OPTION_FAST_POLL_RECOVERY       0x40
#define SDLC_OPTION_INITIATE_FAST_SDLC       0x80
#define SDLC_OPTION2_DISCONNECT_NEG          0x01
#define X75_OPTION_WAIT_CTS_DCD_ON           0x00000001
#define X75_OPTION_INDICATE_CTS_DCD_ON       0x00000002
#define X75_OPTION_PASS_INDICATIONS          0x00000004
#define X75_OPTION_DISCONNECT_NEG            0x00000008
/* ==========================================================
...
Fields in assign CAI information element:
  ...
  <byte> modem carrier wait time (seconds)
  <byte> modem carrier loss time (1/10 seconds)
  <struct> modem reserved
...
#define DSP_CAI_ARRANGEMENT_CONNECTION     0x00
#define DSP_CAI_ARRANGEMENT_LINE_SIDE      0x01
#define DSP_CAI_ARRANGEMENT_NULL_PLCI      0x02
#define DSP_CAI_ARRANGEMENT_LINE_RESERVED  0x03
#define DSP_CAI_ARRANGEMENT_DATA_STUB      0x04
#define DSP_CAI_ARRANGEMENT_LINE_STUB      0x05
#define DSP_CAI_ARRANGEMENT_DATA_NO_CLOCK  0x06
#define DSP_CAI_ARRANGEMENT_LINE_NO_CLOCK  0x07
#define DSP_CAI_ARRANGEMENT_LINE_FLAG      0x01
#define DSP_CAI_ARRANGEMENT_MASK           0x0f
...
#define DSP_CAI_MODEM_V29FC_ANS_TIME_256MS 0x00
#define DSP_CAI_MODEM_V29FC_ANS_TIME_288MS 0x08
#define DSP_CAI_MODEM_V29FC_ANS_TIME_320MS 0x10
#define DSP_CAI_MODEM_V29FC_ANS_TIME_352MS 0x18
#define DSP_CAI_MODEM_V29FC_ANS_TIME_MASK  0x18
...
#define DSP_CAI_MODEM_DISABLE_STEPDOWN     0x02
#define DSP_CAI_MODEM_DISABLE_SPLIT_SPEED  0x04
#define DSP_CAI_MODEM_SHORT_ANSWER_TONE    0x08
#define DSP_CAI_MODEM_ALLOW_RDL_TEST_LOOP  0x10
#define DSP_CAI_MODEM_DISABLE_STEPUP       0x20
...
#define DSP_CAI_MODEM_ENABLE_V90A          0x04
#define DSP_CAI_MODEM_ENABLE_V22FC         0x08
#define DSP_CAI_MODEM_ENABLE_V22BISFC      0x10
#define DSP_CAI_MODEM_ENABLE_V29FC         0x20
#define DSP_CAI_MODEM_ENABLE_V27FC         0x40
#define DSP_CAI_MODEM_ENABLE_V34FC         0x80
...
#define DSP_CAI_MODEM_EXTENDED_LEC         0x80
...
#define DSP_CAI_MODEM_DISABLE_MANUALREDUCT 0x20
#define DSP_CAI_MODEM_DISABLE_16_POINT_TRN 0x40
#define DSP_CAI_MODEM_EXTENDED_TRAINING    0x80
...
#define DSP_CAI_MODEM_ANSWER_TONE_TIME_256 0xf0
/* ==========================================================
    DCD/CTS State
   ========================================================== */
...
#define MDM_CAPI_GUARD_MASK           0x000c
#define MDM_CAPI_SPEAKER_OFF          0x0000
#define MDM_CAPI_SPEAKER_TIL_CONNECT  0x0010
#define MDM_CAPI_SPEAKER_ALWAYS_ON    0x0020
#define MDM_CAPI_SPEAKER_MASK         0x0030
#define MDM_CAPI_VOLUME_SILENT        0x0000
#define MDM_CAPI_VOLUME_NORMAL_LOW    0x0040
#define MDM_CAPI_VOLUME_NORMAL_HIGH   0x0080
#define MDM_CAPI_VOLUME_MAXIMUM       0x00c0
#define MDM_CAPI_VOLUME_MASK          0x00c0
