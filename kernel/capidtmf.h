...
#define DSPDTMF_RX_SENSITIVITY_LOW_DEFAULT	83	/* -39 dBm */
#define DSPDTMF_RX_SENSITIVITY_HIGH_DEFAULT	83	/* -39 dBm */
...
typedef struct tag_capidtmf_recv_state
{
  ...
  short cycle_counter0;
  int32 fundamental_accumulator0;
  int32 goertzel_buffer0[2][CAPIDTMF_RECV_TOTAL_FREQUENCY_COUNT];
  int32 fundamental_accumulator;
  int32 goertzel_buffer[2][CAPIDTMF_RECV_TOTAL_FREQUENCY_COUNT];
