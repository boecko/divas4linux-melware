...
/*
	Turn History on/off
	*/
typedef int (*DivaSTraceSetHistory_proc_t)(void* hLib, int on);
...
/*
	Set max trace data record length
	*/
typedef int (*DivaSTraceSetMaxTraceRecordLength_proc_t)(void* hLib, word max_trace_record_length);

/*
	Line state events
	*/
typedef int (*DivaSTraceSetLineState_proc_t)(void* hLib, int on);

/*
	Modem state events
	*/
typedef int (*DivaSTraceSetModemState_proc_t)(void* hLib, int on);

/*
	Fax state events
	*/
typedef int (*DivaSTraceSetFaxState_proc_t)(void* hLib, int on);

/*
	Line statistics
	*/
typedef int (*DivaSTraceSetLineStatistics_proc_t)(void* hLib, int on);

/*
	Log Control
	*/
typedef int (*DivaSTraceLogControl_proc_t)(void* hLib, int on);
...
typedef struct _diva_strace_library_interface {
  ...
  DivaSTraceLibraryStart_proc_t DivaSTraceLibraryStop;
	...
	DivaSTraceSetHistory_proc_t		DivaSTraceSetHistory;
	...
	DivaSTraceSetMaxTraceRecordLength_proc_t \
																DivaSTraceSetMaxTraceRecordLength;
	DivaSTraceSetLineState_proc_t  DivaSTraceSetLineState;
	DivaSTraceSetModemState_proc_t DivaSTraceSetModemState;
	DivaSTraceSetFaxState_proc_t   DivaSTraceSetFaxState;
	DivaSTraceSetLineStatistics_proc_t DivaSTraceSetLineStatistics;
	DivaSTraceLogControl_proc_t        DivaSTraceLogControl;
