 ...
 *
  This source file is supplied for the use with Dialogic
  range of DIVA Server Adapters.
 *
...
void diva_maint_connect_to_cfg_lib (void* dadapter);
...
dword diva_maint_get_bufsize(void) ;
...
#define DIVA_MGT_DBG_HISTORY		0x00000800 /* History activation */
