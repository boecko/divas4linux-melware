...
#define DIVA_PRI_V3_BOOT_SIGNATURE    0x480      /* Startup signature location  */
#define DIVA_PRI_V3_BOOT_COUNT        0x484      /* Adapter boot count location */
#define DIVA_PRI_V3_BOOT_SIGNATURE_OK 0x88888888 /* Startup signature */
/*----------------------------------------------------------------------------*/
...
#define MQ2_FPGA_INFO_ROM               0x0800
/*----------------------------------------------------------------------------*/
...
/*--------------------------------------------------------------------------*/
#define DIVA_4PRI_LED_CTRL_REG_OFFSET   0x7000
#define DIVA_4PRI_FPGA_INFO_REG_OFFSET  0x9000
#define DIVA_4PRI_RESET_REG_OFFSET      0x3004
#define DIVA_4PRI_DSP_RESET_REG_OFFSET  0x3000
#define DIVA_4PRI_SYS_STATUS_REG_OFFSET 0x6000
#define DIVA_4PRI_HW_DEBUG_ADDRESS_REG_OFFSET 0xa000
#define DIVA_4PRI_HW_DEBUG_COMMAND_REG_OFFSET 0xa004
#define DIVA_4PRI_HW_DEBUG_FPGA_BUS_STATE_REG_OFFSET 0xb000
#define DIVA_4PRI_DSP_LOAD_RAM_OFFSET         0x3100
#define DIVA_4PRI_DSP_LOAD_RAM_LENGTH         256
#define DIVA_4PRI_DSP_BOOT_CHANNEL_SELECT_REG_OFFSET 0x300c /* Bits 0...19, write only */
#define DIVA_4PRI_DSP_BOOT_CHANNEL_STATUS_REG_OFFSET DIVA_4PRI_DSP_BOOT_CHANNEL_SELECT_REG_OFFSET /* Read only */

/*
  Clock interrupt
  */
#define DIVA_4PRI_FPGA_CLOCK_SELECTION_REGISTER_OFFSET      0x7010
#define DIVA_4PRI_FPGA_CLOCK_SELECTION_REGISTER_OFF         0
#define DIVA_4PRI_FPGA_CLOCK_SELECTION_REGISTER_PORT_1      (1U << 28)
#define DIVA_4PRI_FPGA_CLOCK_SELECTION_REGISTER_PORT_2      (1U << 29)
#define DIVA_4PRI_FPGA_CLOCK_SELECTION_REGISTER_PORT_3      (1U << 30)
#define DIVA_4PRI_FPGA_CLOCK_SELECTION_REGISTER_PORT_4      (1U << 31)
#define DIVA_4PRI_FPGA_CLOCK_INTERRUPT_ACKNOWLEDGE_REGISTER 0x7020
#define DIVA_4PRI_FPGA_CLOCK_INTERRUPT_STATUS_REGISTER      0x7030
#define DIVA_4PRI_FPGA_CLOCK_INTERRUPT_STATUS_ON            (1U << 31)
#define DIVA_4PRI_FPGA_CLOCK_INTERRUPT_STATUS_COUNTER       (0x7fU << 24)
