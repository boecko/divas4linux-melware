...
#define DBG_ENABLE_XLOG 7
#define DBG_DISABLE_XLOG 8
#define DBG_ENABLE_DLOG 9
#define DBG_DISABLE_DLOG 10
/*
 ...
 */
#define IOCTL_DRIVER_LNK  CTL_CODE(0x8001U,0x701,METHOD_OUT_DIRECT,FILE_ANY_ACCESS)
#define IOCTL_DRIVER_DBG  CTL_CODE(0x8001U,0x702,METHOD_OUT_DIRECT,FILE_ANY_ACCESS)
#endif  
